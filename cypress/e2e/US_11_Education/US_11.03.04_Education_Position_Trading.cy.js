...
describe("Education > Menu Item [Position Trading]", () => {
    ...
    langNameList.forEach((langName, ind) => {
        it(`TC_11.03.04_01 | Education > Menu Item [Position Trading] > Test button [Log in] in the header of ${langName} language`, function () {
    ...
    langNameList.forEach((langName, ind) => {
        it(`TC_11.03.04_02 | Education > Menu Item [Position Trading] > Test button [Trade] in the header ${langName} language`, () => {
    ...
    langNameList.forEach((langName, ind) => {
        it(`TC_11.03.04_03 | Education > Menu Item [Position Trading] > Test button [Start Trading] in Main banner ${langName} language`, () => {
    ...
    langNameList.forEach((langName, ind) => {
        it(`TC_11.03.04_04 | Education > Menu Item [Position Trading] > Test button [Try Demo] in Main banner ${langName} language`, () => {
    ...
    langNameList.forEach((langName, ind) => {
        it(`TC_11.03.04_05 | Educations > Menu item [Position trading] > Test buttons [Trade] on Widget "Most traded" ${langName} language`, () => {
    ...
    langNameList.forEach((langName, ind) => {
        it(`TC_11.03.04_06 | Education > Menu Item [Position Trading] > Test button [Download on the App Store] in the block "Sign up and trade smart today" ${langName} language`, () => {
    ...
    langNameList.forEach((langName, ind) => {
        it(`TC_11.03.04_07 | Education > Menu Item [Position Trading] > Test button [Get it on Google Play] in the block "Sign up and trade smart today" ${langName} language`, () => {
